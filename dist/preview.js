...
},{}],"5DffB":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "0ec47630371e291a";
module.bundle.HMR_BUNDLE_ID = "e0be9cdcf8eb8d45";
...
},{}],"fswI6":[function(require,module,exports) {
(function() {
    /**
   ...
   * @return string
   */ var generateStringValue = function(value) {
        alphaEnabled = false;
        ...
        if (alphaEnabled) formattedValue = colorMode + '(' + pos1 + ', ' + pos2 + ', ' + pos3 + ', ' + pos4 + ')';
        else formattedValue = colorMode + '(' + pos1 + ', ' + pos2 + ', ' + pos3 + ')';
   ...
   */ var stylesOutput = function(styles, value, output, controlType) {
        if ('kirki-react-colorful' !== controlType) return styles;
        if ('string' === typeof value || 'number' === typeof value) return styles;
        styles += output.element + '{' + output.property + ': ' + generateStringValue(value) + ';\
		}';
        return styles;
...
},{}]},["jAg0Z","5DffB","fswI6"], "fswI6", "parcelRequire4303")
