 ...
 */ var KirkiReactColorfulForm = function(props) {
   ...
   */ var handleSwatchesClick = function(swatchColor) {
    ...
    var ref4 = _helpers.slicedToArray(_react.useState(false), 2), mountPicker = ref4[0], setMountPicker = ref4[1];
    ...
    var closePicker = function() {
        if (isPickerOpen) {
            ...
            }, 250); // 200 is the closing animation duration set in control.scss and 50 is the extra wait before unmounting the picker.
    ...
    }, !useHueMode && mountPicker && /*#__PURE__*/ React.createElement(_kirkiReactColorfulSwatchesDefault.default, {
        colors: choices.swatches,
        onClick: handleSwatchesClick
    }), mountPicker && /*#__PURE__*/ React.createElement(KirkiPickerComponent, {
        color: pickerValue,
        onChange: handlePickerChange
    }), 'button' === choices.triggerStyle ? formInput : '')));
};
_s(KirkiReactColorfulForm, "k59NL1X6zLx/H9pvZTPFtOeoJkQ=", false, function() {
